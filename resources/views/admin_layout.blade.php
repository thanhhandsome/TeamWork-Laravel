        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ URL::to('/add-brand-product') }}">Thêm nhà sản xuất</a></li>
						<li><a href="{{ URL::to('/all-brand-product') }}">Liệt kê nhà sản xuất</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="glyphicon.html">Liệt kê chi tiết sản phẩm</a></li>
